...
Database changed
MariaDB [csd2204s18]> CREATE TABLE IF NOT EXISTS `employees` (
...
MariaDB [csd2204s18]> INSERT INTO `employees` (`EMPLOYEE_ID`, `FIRST_NAME`, `LAST_NAME`, `EMAIL`, `PHONE_NUMBER`, `HIRE_DATE`, `JOB_ID`, `SALARY`, `COMMISSION_PCT`, `MANAGER_ID`, `DEPARTMENT_ID`) VALUES
...
Query OK, 107 rows affected (0.05 sec)
Records: 107  Duplicates: 0  Warnings: 0

MariaDB [csd2204s18]> CREATE TABLE IF NOT EXISTS `job_history` (
...
MariaDB [csd2204s18]> INSERT INTO `job_history` (`EMPLOYEE_ID`, `START_DATE`, `END_DATE`, `JOB_ID`, `DEPARTMENT_ID`) VALUES
...
MariaDB [csd2204s18]> CREATE TABLE IF NOT EXISTS `jobs` (
...
MariaDB [csd2204s18]> INSERT INTO `jobs` (`JOB_ID`, `JOB_TITLE`, `MIN_SALARY`, `MAX_SALARY`) VALUES
...
MariaDB [csd2204s18]> 
MariaDB [csd2204s18]> CREATE TABLE IF NOT EXISTS `locations` (
...
MariaDB [csd2204s18]> 
MariaDB [csd2204s18]> INSERT INTO `locations` (`LOCATION_ID`, `STREET_ADDRESS`, `POSTAL_CODE`, `CITY`, `STATE_PROVINCE`, `COUNTRY_ID`) VALUES
...
MariaDB [csd2204s18]> CREATE TABLE IF NOT EXISTS `regions` (
...
MariaDB [csd2204s18]> 
MariaDB [csd2204s18]> INSERT INTO `regions` (`REGION_ID`, `REGION_NAME`) VALUES
    -> ('1', 'Europe\r'),
    -> ('2', 'Americas\r'),
    -> ('3', 'Asia\r'),
...
MariaDB [csd2204s18]> select salary, job_id from employees where job-id = sh_clerk
    -> /;
...
MariaDB [csd2204s18]> SELECT MAX(SALARY) FRO EMPLOYEES WHERE JOB_ID ='SH_CLERK';
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'EMPLOYEES WHERE JOB_ID ='SH_CLERK'' at line 1
...
MariaDB [csd2204s18]> select first_name,last_name, salary from employees where salary < ANY (SELECTSALARY FROM EMPLOYEES WHERE JOB_ID ='SH_CLERK') ORDER BY SALARY;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'SELECTSALARY FROM EMPLOYEES WHERE JOB_ID ='SH_CLERK') ORDER BY SALARY' at line 1
...
MariaDB [csd2204s18]> select first_name,last_name, from employees WHERE EMPLOYEE_ID IN (SELECT DISTINCT (manager_d) from employees where manager_id<> 0;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from employees WHERE EMPLOYEE_ID IN (SELECT DISTINCT (manager_d) from employees ' at line 1
MariaDB [csd2204s18]> select first_name,last_name, from employees WHERE EMPLOYEE_ID IN (SELECT DISTINCT (manager_d) from employees where manager_id<> 0);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from employees WHERE EMPLOYEE_ID IN (SELECT DISTINCT (manager_d) from employees ' at line 1
...
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from employees WHERE EMPLOYEE_ID IN (SELECT DISTINCT (manager_id) from employees' at line 1
MariaDB [csd2204s18]> select first_name,last_name, from employees WHERE EMPLOYEE_ID IN (SELECT DISTINCT (manager_id) from employees where manager_id != 0);
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from employees WHERE EMPLOYEE_ID IN (SELECT DISTINCT (manager_id) from employees' at line 1
...
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from employees WHERE EMPLOYEE_ID NOT IN (SELECT DISTINCT (manager_id) from emplo' at line 1
...
MariaDB [csd2204s18]> SELECT  B.FIRSTp_NAME,B.LAST_NAME FROM EMPLOYEES B WHERE NOT EXISTS (SELECT 'X' FROM EMPLOYEES A WHERE A.MANAGER_ID =B.EMPLOYEE_ID);
ERROR 1054 (42S22): Unknown column 'B.FIRSTp_NAME' in 'field list'
...
MariaDB [csd2204s18]> CREATE TABLE IF NOT EXISTS `departments` (
...
MariaDB [csd2204s18]> INSERT INTO `departments` (`DEPARTMENT_ID`, `DEPARTMENT_NAME`, `MANAGER_ID`, `LOCATION_ID`) VALUES
...
MariaDB [csd2204s18]> SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME,(SELECT DEPARTMENT_NAME FROM DEPARTMENT D WHERE E.DEPARTMENT_ID = D.DEPARTMENT_ID)DEPARTMENT FROM EMPLOYEES E ORDER BY DEPARTMENT;
ERROR 1146 (42S02): Table 'csd2204s18.department' doesn't exist
MariaDB [csd2204s18]> SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME,(SELECT DEPARTMENT_NAME FROM DEPARTMENTS D WHERE E.DEPARTMENT_ID = D.DEPARTMENT_ID)DEPARTMENTS FROM EMPLOYEES E ORDER BY DEPARTMENT;
...
MariaDB [csd2204s18]> SELECT FIRST_NAME,LAST_NAME ,(SELECT DEPARTMENT_NAME FROM DEPARTMENTS D WHERE D.DEPARTMENT_ID = E.DEPARTMENT_ID) "DEPARTMENT NAME " FROM EMPLOYEE;
...
MariaDB [csd2204s18]> SELECT AVG(SALARY),DEPARTMENT_ID FROM EMPLOYEES GROUP BY EPARTMENT_ID;
ERROR 1054 (42S22): Unknown column 'EPARTMENT_ID' in 'group statement'
...
MariaDB [csd2204s18]> SELECT FIRST_NAME,LAST_NAME,SALARY FROM EMPLOYEES E WHERE SALARY> (SELECT AVG(SALARY) FROM EMPLOYEES GROUP BY DEPATMENT_ID HAVING DEPARTMENT_ID =E.DEPARTMENT_ID
    -> /;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '' at line 2
MariaDB [csd2204s18]> SELECT FIRST_NAME,LAST_NAME,SALARY FROM EMPLOYEES E WHERE SALARY> (SELECT AVG(SALARY) FROM EMPLOYEES GROUP BY DEPATMENT_ID HAVING DEPARTMENT_ID =E.DEPARTMENT_ID;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '' at line 1
MariaDB [csd2204s18]> SELECT FIRST_NAME,LAST_NAME,SALARY FROM EMPLOYEES E WHERE SALARY> (SELECT AVG(SALARY) FROM EMPLOYEES GROUP BY DEPATMENT_ID HAVING DEPARTMENT_ID =E.DEPARTMENT_ID);
ERROR 1054 (42S22): Unknown column 'DEPATMENT_ID' in 'group statement'
...
MariaDB [csd2204s18]> SELECT DISTINCT(SALARY) FROM EMPLOYEES E1 WHERE 5 = (SELECT COUNT(DISTINCT SALARY) FROM EMPLOYEES E1 WHERE E. SALARY >= E2.SALARY);
ERROR 1054 (42S22): Unknown column 'E.SALARY' in 'where clause'
MariaDB [csd2204s18]> SELECT DISTINCT(SALARY) FROM EMPLOYEES E1 WHERE 5 = (SELECT COUNT(DISTINCT SALARY) FROM EMPLOYEES E1 WHERE E.SALARY >= E2.SALARY);
ERROR 1054 (42S22): Unknown column 'E.SALARY' in 'where clause'
MariaDB [csd2204s18]> SELECT DISTINCT(SALARY) FROM EMPLOYEES E1 WHERE 5 = (SELECT COUNT(DISTINCT SALARY) FROM EMPLOYEES E1 WHERE E1.SALARY >= E2.SALARY);
ERROR 1054 (42S22): Unknown column 'E2.SALARY' in 'where clause'
MariaDB [csd2204s18]> SELECT DISTINCT(SALARY) FROM EMPLOYEES E1 WHERE 5 = (SELECT COUNT(DISTINCT SALARY) FROM EMPLOYEES E2 WHERE E1.SALARY >= E2.SALARY);
+---------+
| SALARY  |
+---------+
| 2600.00 |
...
MariaDB [csd2204s18]> SELECT DISTINCT(SALARY) FROM EMPLOYEES E1 WHERE 3 = (SELECT COUNT(DISTINCT SALARY) FROM EMPLOYEES E2 WHERE E1.SALARY <=E2.SALARY);
+----------+
| SALARY   |
+----------+
| 14000.00 |
...
MariaDB [csd2204s18]> SELECT * FROM (SELECT * FROM EMPLOYEES ORDER BY EMPLOYEES EMPLOYEE_ID DESC LIMIT 10)E1 ORDER BY EMPLOYEE_ID ASC;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'EMPLOYEE_ID DESC LIMIT 10)E1 ORDER BY EMPLOYEE_ID ASC' at line 1
...
MariaDB [csd2204s18]> SELECT DEPARTMENT_ID,DEPARTMENT_NAME FROM DEPARTMENTS WHERE DEPATMENT_ID NOT IN (SELECT DISTINCT(DEPARTMENT_ID) FROM EMPLOYEES);
